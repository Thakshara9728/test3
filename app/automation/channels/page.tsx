...
import ChannelCard from '@/app/components/channels/ChannelCard';
import NewChannelModal from '@/app/components/channels/NewChannelModal';
...
export default function ChannelsPage() {
  ...
  // Reload channels when modal closes
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <button
            ...
            className="px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-medium rounded-xl shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50 transition-all flex items-center gap-2"
          >
        ...
        {!loading && channels.length === 0 && (
          <div className="bg-white dark:bg-slate-900 rounded-2xl border-2 border-dashed border-slate-300 dark:border-slate-700 p-16">
            <div className="max-w-md mx-auto text-center">
              ...
              <button
                onClick={() => setShowModal(true)}
                className="px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-medium rounded-xl shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50 transition-all"
              >
      ...
      {/* Modal */}
      <NewChannelModal isOpen={showModal} onClose={handleModalClose} />
    </div>
  );
}
